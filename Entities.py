# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 10:30:54 2017
...
def PERSON(text):
    ...
    if len(person) > 1:
        dict_person = {}
        dict_person['PERSON'] = person
        list_person.append(dict_person)
        return list_person
    elif len(person) == 1:
        dict_person = {}
        dict_person['PERSON'] = person[0]
        list_person.append(dict_person)
        return list_person
    elif len(person) == 0:
...
def FACILITY(text):
    ...
    if len(facility) > 1:
        dict_facility = {}
        dict_facility['FACILITY'] = facility
        list_facility.append(dict_facility)
        return list_facility
    elif len(facility) == 1:
        dict_facility = {}
        dict_facility['FACILITY'] = facility[0]
        list_facility.append(dict_facility)
        return list_facility
    else:
        return list_facility
...
def WORK_OF_ART(text):
    ...
    if len(woa) > 1:
        dict_woa = {}
        dict_woa['WORK OF ART'] = woa
        list_woa.append(dict_woa)
        return list_woa
    elif len(woa) == 1:
        dict_woa = {}
        dict_woa['WORK OF ART'] = woa[0]
        list_woa.append(dict_woa)
        return list_woa
    else:
        return list_woa
...
def LANGUAGE(text):
    ...
    if len(language) > 1:
        dict_language = {}
        dict_language['LANGUAGE'] = language
        list_language.append(dict_language)
        return list_language
    elif len(language) == 1:
        dict_language = {}
        dict_language['LANGUAGE'] = language[0]
        list_language.append(dict_language)
        return list_language
    else:
        return list_language
...
def PERCENT(text):
    ...
    if len(percent) > 1:
        dict_percent = {}
        dict_percent['PERCENT'] = percent
        list_percent.append(dict_percent)
        return list_percent
    elif len(percent) == 1:
        dict_percent = {}
        dict_percent['PERCENT'] = percent[0]
        list_percent.append(dict_percent)
        return list_percent
    else:
        return list_percent
...
def QUANTITY(text):
    ...
    if len(quantity) > 1:
        ...
        dict_quantity = {}
        dict_quantity['QUANTITY'] = quantity[0]
        list_quantity.append(dict_quantity)
        return list_quantity
    else:
        return list_quantity
...
def ORDINAL(text):
    ...
    if len(ordinal) > 1:
        dict_ordinal = {}
        dict_ordinal['ORDINAL'] = ordinal
        list_ordinal.append(dict_ordinal)
        return list_ordinal
    elif len(ordinal) == 1:
        dict_ordinal = {}
        dict_ordinal['ORDINAL'] = ordinal[0]
        list_ordinal.append(dict_ordinal)
        return list_ordinal
    else:
        return list_ordinal
...
def CARDINAL(text):
    ...
    if len(cardinal) > 1:
        dict_cardinal = {}
        dict_cardinal['CARDINAL'] = cardinal
        list_cardinal.append(dict_cardinal)
        return list_cardinal
    elif len(cardinal) == 1:
        dict_cardinal = {}
        dict_cardinal['CARDINAL'] = cardinal[0]
        list_cardinal.append(dict_cardinal)
        return list_cardinal
    else:
        return list_cardinal
...
def FULLADDRESS(text):
    ...
    if len(address) > 1:
        dict_address = {}
        dict_address['FULL ADDRESS'] = address
        list_address.append(dict_address)
        return list_address
    elif len(address) == 1:
        dict_address = {}
        dict_address['FULL ADDRESS'] = address[0]
        list_address.append(dict_address)
        return list_address
    else:
        return list_address
...
def STREETADDRESS(text):
    ...
    if len(address) > 1:
        dict_address = {}
        dict_address['STREET ADDRESS'] = address
        list_address.append(dict_address)
        return list_address
    elif len(address) == 1:
        dict_address = {}
        dict_address['STREET ADDRESS'] = address[0]
        list_address.append(dict_address)
        return list_address
    else:
        return list_address
...
def PHONENUMBER(text):
    ...
    if len(phone) > 1:
        dict_phone = {}
        dict_phone['PHONE NUMBER'] = phone
        list_phone.append(dict_phone)
        return list_phone
    elif len(phone) == 1:
        dict_phone = {}
        dict_phone['PHONE NUMBER'] = phone[0]
        list_phone.append(dict_phone)
        return list_phone
    else:
        return list_phone
...
def ZIP(text):
    ...
    if len(zipcode) > 1:
        dict_zipcode = {}
        dict_zipcode['ZIP'] = zipcode
        list_zipcode.append(dict_zipcode)
        return list_zipcode
    elif len(zipcode) == 1:
        dict_zipcode = {}
        dict_zipcode['ZIP'] = zipcode[0]
        list_zipcode.append(dict_zipcode)
        return list_zipcode
    else:
        return list_zipcode
...
def BITCOINADDRESS(text):
    ...
    if len(addr) > 1:
        dict_addr = {}
        dict_addr['BITCOIN ADDRESS'] = addr
        list_addr.append(dict_addr)
        return list_addr
    elif len(addr) == 1:
        dict_addr = {}
        dict_addr['BITCOIN ADDRESS'] = addr[0]
        list_addr.append(dict_addr)
        return list_addr
    else:
        return list_addr
...
def CREDITCARD(text):
    ...
    if len(details) > 1:
        dict_details = {}
        dict_details['CREDIT CARD DETAILS'] = details
        list_details.append(dict_details)
        return list_details
    elif len(details) == 1:
        dict_details = {}
        dict_details['CREDIT CARD DETAILS'] = details[0]
        list_details.append(dict_details)
        return list_details
    else:
        return list_details
